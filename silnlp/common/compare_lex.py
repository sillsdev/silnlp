...
def main() -> None:
    ...
    parser.add_argument(
        "--stats",
        help="True or False: Output word count and number of renderings for common words",
        action="store_true",
    )
    parser.add_argument(
        "--src", help="If set, only the source side of the two experiment lexicons is compared", action="store_true"
    )
    parser.add_argument(
        "--trg", help="If set, only the target side of the two experiment lexicons is compared", action="store_true"
    )
    ...
    lex_path1 = environment.align_experiments_dir / args.exp1
    lex_path2 = environment.align_experiments_dir / args.exp2
