...
def main() -> None:
    ...
    parser.add_argument("--folder", help="Folder with corpus of Bible extracts")
    parser.add_argument("--files", default="*-*.txt", help="Pattern of extract file names to count")
    parser.add_argument("--output", default="verse_counts.tsv")
    ...
    verse_count_df.to_csv(output_path, sep='\t')
