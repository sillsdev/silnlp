...
with resource_tab:
    ...
    with settings_tab:
        ...
        with st.form(key='set_up_form') as f:
            root = st.text_input('Link to investigations root folder', placeholder='https://drive.google.com/drive/u/0/folders/0000000000000000000', value=f"https://drive.google.com/drive/u/0/folders/{functions.current_context()}")
            data_folder = st.text_input('Link to data folder',placeholder='https://drive.google.com/drive/u/0/folders/0000000000000000000', value=f"https://drive.google.com/drive/u/0/folders/{functions.current_data()}" if functions.current_data() is not None else '')
            check_error('set_up')
